...
[assembly: InternalsVisibleTo("LiteStringBuilder11.Tests")]
namespace StringHelper
{
    ...
    ///</summary>
    public class LiteStringBuilder11
    {
        ...
        private  Bucket2[] _buckets = new Bucket2[4];
...
#pragma warning restore HAA0501 // Explicit new array type allocation
  {
        ...
        private int TotalLength
        {
            ...
            get
            {
                return _totalLength + this._buckets[_bucketIndex].Length;
            }
        }
        ...
        /// <summary>
        /// Get a new instance of LiteStringBuilder11
        /// </summary>
        /// <param name="initialCapacity"></param>
        /// <returns></returns>
        public static LiteStringBuilder11 Create(int initialCapacity = DefaultCapacity)
        {
            return new LiteStringBuilder11(initialCapacity);
        }

        public LiteStringBuilder11(int initialCapacity = DefaultCapacity)
        {
            int capacity = initialCapacity > 0 ? initialCapacity : DefaultCapacity;
            this._buckets[0] = new Bucket2(new char[capacity], 0, 0);
        }

        public LiteStringBuilder11(string value)
        {
            ...
            {
                this._buckets[0] = new Bucket2(new char[DefaultCapacity], 0, 0);
            }
        }
        ...
        private static readonly SpanAction<char, ValueTuple<Bucket2[],int>> StringCreationAction = (span, ctx) =>
        {
...
#if NETCOREAPP3_0 || NETSTANDARD2_1
            return string.Create(totalLength, (_buckets, _bucketIndex), StringCreationAction);
#else
            int copyIndex = 0;
        ...
        {
            return Equals(obj as LiteStringBuilder11);
        }
        public bool Equals(LiteStringBuilder11 other)
        {
            // Check for null
            if (other is null)
            {
        ...
        public LiteStringBuilder11 Clear()
        {
            _totalLength = 0;
            _buckets = Array.Empty<Bucket2>();
            return this;
        }

        ///<summary>Will allocate on the array creatation, and on boxing values</summary>
        public LiteStringBuilder11 Append(params object[] values)
        {
            if (values != null)
            {
        ...
        public LiteStringBuilder11 Append<T>(params T[] values)
        {
        ...
        public LiteStringBuilder11 Append(string value)
        {
            if (value != null)
            {
                ...
                if (length > 0)
                {
                    ...
                    int pos = _buckets[_bucketIndex].Length;
                    var buffer = _buckets[_bucketIndex].Buffer;
                    ...
                    _buckets[_bucketIndex].Length += length;
                }
            }
            return this;
        }
        ...
        //public LiteStringBuilder11 AppendLine()
        //{
        //    return Append(Environment.NewLine);
        //}

        /////<summary>Append a string and new line without memory allocation</summary>
        //public LiteStringBuilder11 AppendLine(string value)
        //{
        //    Append(value);
        //    return Append(Environment.NewLine);
        //}
        ...
        //public LiteStringBuilder11 Append(char value)
        //{
...
//        public LiteStringBuilder11 Append(bool value)
//        {
//            if (value)
//            {
//                //true
...
//        public LiteStringBuilder11 Append(object value)
//        {
//            if (value is null)
//                return this;
...
//        public LiteStringBuilder11 Append(DateTime value)
//        {
...
//        public LiteStringBuilder11 Append(sbyte value)
//        {
//            if (value < 0)
//            {
...
//        public LiteStringBuilder11 Append(byte value)
//        {
...
//        public LiteStringBuilder11 Append(uint value)
//        {
//            return Append((ulong)value, false);
//        }

//        ///<summary>Append an ulong without memory allocation</summary>
//        public LiteStringBuilder11 Append(ulong value)
//        {
//            return Append(value, false);
//        }

//        ///<summary>Append an int without memory allocation</summary>
//        public LiteStringBuilder11 Append(short value)
//        {
...
//        ///<summary>Append an int without memory allocation</summary>
//        public LiteStringBuilder11 Append(int value)
//        {
...
//        public LiteStringBuilder11 Append(float value)
//        {
//            return Append(value.ToString(s_Culture));
//        }

//        public LiteStringBuilder11 Append(decimal value)
//        {
//            return Append(value.ToString(s_Culture));
//        }


//        public LiteStringBuilder11 Append(long value)
//        {
//            bool isNegative = value < 0;
//            if (isNegative)
//            {
...
//        [MethodImpl(MethodImplOptions.AggressiveInlining)]
//        private LiteStringBuilder11 Append(ulong value, bool isNegative)
//        {
...
//        public LiteStringBuilder11 Append(double value)
//        {
//            return Append(value.ToString(s_Culture));
//        }
...
//#endif
//        private LiteStringBuilder11 InternalAppend(float valueF)
//        {
//            double value = valueF;
...
//        [ExcludeFromCodeCoverage]
//#endif
//        private LiteStringBuilder11 InternalAppend(double value)
//        {
...
//        public LiteStringBuilder11 Replace(string oldStr, string newStr)
//        {
//            if (_bufferPos == 0)
//                return this;
...
//        public LiteStringBuilder11 Replace2(string oldStr, string newStr)
//        {
//            if (_bufferPos == 0)
//                return this;
...
//        }
        ...
        {
            var buffer = this._buckets[_bucketIndex].Buffer;
            int currentCapacity = buffer.Length;
            int pos = this._buckets[_bucketIndex].Length;
                ...
                if (pos > 0)
                {
                    if (pos != currentCapacity)
                    {
                       ...
                       new Span<char>(buffer, 0, pos).TryCopyTo(new Span<char>(newItems));
                        this._buckets[_bucketIndex].Buffer = newItems;
                    }
                    ...
                    //copy data
                    _bucketIndex++;
                    _buckets[_bucketIndex] = new Bucket2(newBuffer, 0, _totalLength);
                }
                else
                {
                    //copy data
        ...
        private void EnsureBucketCapacity()
        {
            ...
            if (len== index)
            {
                Bucket2[] newItems = new Bucket2[len + 4];
                if (index > 0)
                {
#if NETCOREAPP3_0 || NETCOREAPP1_0 || NETCOREAPP1_1 || NETCOREAPP2_0
                    new Span<Bucket2>(_buckets, 0, index).CopyTo(new Span<Bucket2>(newItems));
#else
