...
[assembly: InternalsVisibleTo("LiteStringBuilder9.Tests")]
namespace StringHelper
{
    ...
    ///</summary>
    public class LiteStringBuilder9
    {
...
#pragma warning restore HAA0501 // Explicit new array type allocation
  {
        ...
        /// <summary>
        /// Get a new instance of LiteStringBuilder9
        /// </summary>
        /// <param name="initialCapacity"></param>
        /// <returns></returns>
        public static LiteStringBuilder9 Create(int initialCapacity = DefaultCapacity)
        {
            return new LiteStringBuilder9(initialCapacity);
        }

        public LiteStringBuilder9(int initialCapacity = DefaultCapacity)
        {
            int capacity = initialCapacity > 0 ? initialCapacity : DefaultCapacity;
            _buffer = new char[capacity];//Pool_Instance.Rent(capacity);
        }

        public LiteStringBuilder9(string value)
        {
        ...
        private static readonly SpanAction<char, ValueTuple<Bucket[],int,char[],int>> StringCreationAction = (span, ctx) =>
        {
            ...
            for (var i = 0; i < bucketLength; i++)
            {
                ...
                bucket.Buffer.AsSpan().CopyTo(position>0 ? span.Slice(position) : span);
                position += bucket.Length;
            }

            if (pos > 0)
            {
                buffer.AsSpan(0, pos).CopyTo(position > 0 ? span.Slice(position) : span);
            }
        };
#endif
        ...
        {
            return Equals(obj as LiteStringBuilder9);
        }
        public bool Equals(LiteStringBuilder9 other)
        {
            // Check for null
            if (other is null)
                return false;
        ...
        public LiteStringBuilder9 Clear()
        {
            _totalLength = 0;
        ...
        public LiteStringBuilder9 Append(params object[] values)
        {
            if (values != null)
            {
        ...
        public LiteStringBuilder9 Append<T>(params T[] values)
        {
        ...
        public LiteStringBuilder9 Append(string value)
        {
            if (value != null)
            {
                int n = value.Length;
        ...
        public LiteStringBuilder9 AppendLine()
        {
            return Append(Environment.NewLine);
        }

        ///<summary>Append a string and new line without memory allocation</summary>
        public LiteStringBuilder9 AppendLine(string value)
        {
            Append(value);
            return Append(Environment.NewLine);
        }
        ...
        public LiteStringBuilder9 Append(char value)
        {
        ...
        public LiteStringBuilder9 Append(bool value)
        {
            if (value)
            {
                //true
        ...
        public LiteStringBuilder9 Append(object value)
        {
            if (value is null)
                return this;
        ...
        public LiteStringBuilder9 Append(DateTime value)
        {
        ...
        public LiteStringBuilder9 Append(sbyte value)
        {
            if (value < 0)
            {
        ...
        public LiteStringBuilder9 Append(byte value)
        {
        ...
        public LiteStringBuilder9 Append(uint value)
        {
            return Append((ulong)value, false);
        }

        ///<summary>Append an ulong without memory allocation</summary>
        public LiteStringBuilder9 Append(ulong value)
        {
            return Append(value, false);
        }

        ///<summary>Append an int without memory allocation</summary>
        public LiteStringBuilder9 Append(short value)
        {
        ...
        ///<summary>Append an int without memory allocation</summary>
        public LiteStringBuilder9 Append(int value)
        {
        ...
        public LiteStringBuilder9 Append(float value)
        {
            return Append(value.ToString(s_Culture));
        }

        public LiteStringBuilder9 Append(decimal value)
        {
            return Append(value.ToString(s_Culture));
        }


        public LiteStringBuilder9 Append(long value)
        {
            bool isNegative = value < 0;
            if (isNegative)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private LiteStringBuilder9 Append(ulong value, bool isNegative)
        {
        ...
        public LiteStringBuilder9 Append(double value)
        {
            return Append(value.ToString(s_Culture));
        }
...
#region OLDCODE
...
#endif
        private LiteStringBuilder9 InternalAppend(float valueF)
        {
            double value = valueF;
        ...
        [ExcludeFromCodeCoverage]
#endif
        private LiteStringBuilder9 InternalAppend(double value)
        {
        ...
        public LiteStringBuilder9 Replace(string oldStr, string newStr)
        {
            if (_bufferPos == 0)
                return this;
        ...
        public LiteStringBuilder9 Replace2(string oldStr, string newStr)
        {
            if (_bufferPos == 0)
                return this;
