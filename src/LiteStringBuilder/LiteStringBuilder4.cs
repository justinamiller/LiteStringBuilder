...
[assembly: InternalsVisibleTo("LiteStringBuilder4.Tests")]
namespace StringHelper
{
    ...
    ///</summary>
    public class LiteStringBuilder4
    {
...
#pragma warning restore HAA0501 // Explicit new array type allocation
  {
        ...
        /// <summary>
        /// Get a new instance of LiteStringBuilder4
        /// </summary>
        /// <param name="initialCapacity"></param>
        /// <returns></returns>
        public static LiteStringBuilder4 Create(int initialCapacity = DefaultCapacity)
        {
            return new LiteStringBuilder4(initialCapacity);
        }

        public LiteStringBuilder4(int initialCapacity = DefaultCapacity)
        {
        ...
        public LiteStringBuilder4(string value)
        {
            if (value != null)
            {
        ...
        public override string ToString()
        {
            ...
            unsafe
            {
                ...
                {
                    return new string(sourcePtr, 0, pos);
                }
            }
        ...
        {
            return Equals(obj as LiteStringBuilder4);
        }
        public bool Equals(LiteStringBuilder4 other)
        {
            // Check for null
            if (other is null)
                return false;
        ...
        public LiteStringBuilder4 Clear()
        {
            _bufferPos = 0;
            return this;
        }
        ...
        public LiteStringBuilder4 Append(params object[] values)
        {
            if (values != null)
            {
        ...
        public LiteStringBuilder4 Append<T>(params T[] values)
        {
        ...
        public LiteStringBuilder4 Append(string value)
        {
            if (value != null)
            {
                int n = value.Length;
        ...
        public LiteStringBuilder4 AppendLine()
        {
            return Append(Environment.NewLine);
        }

        ///<summary>Append a string and new line without memory allocation</summary>
        public LiteStringBuilder4 AppendLine(string value)
        {
            Append(value);
            return Append(Environment.NewLine);
        }
        ...
        public LiteStringBuilder4 Append(char value)
        {
        ...
        public LiteStringBuilder4 Append(bool value)
        {
            if (value)
            {
                //true
        ...
        public LiteStringBuilder4 Append(object value)
        {
            if (value is null)
                return this;
        ...
        public LiteStringBuilder4 Append(DateTime value)
        {
        ...
        public LiteStringBuilder4 Append(sbyte value)
        {
            if (value < 0)
            {
        ...
        public LiteStringBuilder4 Append(byte value)
        {
        ...
        public LiteStringBuilder4 Append(uint value)
        {
            return Append((ulong)value, false);
        }

        ///<summary>Append an ulong without memory allocation</summary>
        public LiteStringBuilder4 Append(ulong value)
        {
            return Append(value, false);
        }

        ///<summary>Append an int without memory allocation</summary>
        public LiteStringBuilder4 Append(short value)
        {
        ...
        ///<summary>Append an int without memory allocation</summary>
        public LiteStringBuilder4 Append(int value)
        {
        ...
        public LiteStringBuilder4 Append(float value)
        {
            return Append(value.ToString(s_Culture));
        }

        public LiteStringBuilder4 Append(decimal value)
        {
            return Append(value.ToString(s_Culture));
        }


        public LiteStringBuilder4 Append(long value)
        {
            bool isNegative = value < 0;
            if (isNegative)
            {
        ...
        private LiteStringBuilder4 Append(ulong value, bool isNegative)
        {
        ...
        public LiteStringBuilder4 Append(double value)
        {
            return Append(value.ToString(s_Culture));
        }
...
#endif
        private LiteStringBuilder4 InternalAppend(float valueF)
        {
            double value = valueF;
        ...
        [ExcludeFromCodeCoverage]
#endif
        private LiteStringBuilder4 InternalAppend(double value)
        {
        ...
        public LiteStringBuilder4 Replace(string oldStr, string newStr)
        {
            if (_bufferPos == 0)
                return this;
