...
[assembly: InternalsVisibleTo("LiteStringBuilder3.Tests")]
namespace StringHelper
{
    ...
    ///</summary>
    public class LiteStringBuilder3
    {
...
#pragma warning restore HAA0501 // Explicit new array type allocation
  {
        ...
        /// <summary>
        /// Get a new instance of LiteStringBuilder3
        /// </summary>
        /// <param name="initialCapacity"></param>
        /// <returns></returns>
        public static LiteStringBuilder3 Create(int initialCapacity = DefaultCapacity)
        {
            return new LiteStringBuilder3(initialCapacity);
        }

        public LiteStringBuilder3(int initialCapacity = DefaultCapacity)
        {
        ...
        public LiteStringBuilder3(string value)
        {
            if (value != null)
            {
        ...
        {
            return Equals(obj as LiteStringBuilder3);
        }
        public bool Equals(LiteStringBuilder3 other)
        {
            // Check for null
            if (other is null)
                return false;
        ...
        public LiteStringBuilder3 Clear()
        {
            _bufferPos = 0;
            return this;
        }
        ...
        public LiteStringBuilder3 Append(params object[] values)
        {
            if (values != null)
            {
        ...
        public LiteStringBuilder3 Append<T>(params T[] values)
        {
        ...
        public LiteStringBuilder3 Append(string value)
        {
        ...
        public LiteStringBuilder3 AppendLine()
        {
            return Append(Environment.NewLine);
        }

        ///<summary>Append a string and new line without memory allocation</summary>
        public LiteStringBuilder3 AppendLine(string value)
        {
            Append(value);
            return Append(Environment.NewLine);
        }
        ...
        public LiteStringBuilder3 Append(char value)
        {
        ...
        public LiteStringBuilder3 Append(bool value)
        {
            if (value)
            {
                //true
        ...
        public LiteStringBuilder3 Append(object value)
        {
            if (value is null)
                return this;
        ...
        public LiteStringBuilder3 Append(DateTime value)
        {
        ...
        public LiteStringBuilder3 Append(sbyte value)
        {
            if (value < 0)
            {
        ...
        public LiteStringBuilder3 Append(byte value)
        {
        ...
        public LiteStringBuilder3 Append(uint value)
        {
            return Append((ulong)value, false);
        }

        ///<summary>Append an ulong without memory allocation</summary>
        public LiteStringBuilder3 Append(ulong value)
        {
            return Append(value, false);
        }

        ///<summary>Append an int without memory allocation</summary>
        public LiteStringBuilder3 Append(short value)
        {
        ...
        ///<summary>Append an int without memory allocation</summary>
        public LiteStringBuilder3 Append(int value)
        {
        ...
        public LiteStringBuilder3 Append(float value)
        {
            return Append(value.ToString(s_Culture));
        }

        public LiteStringBuilder3 Append(decimal value)
        {
            return Append(value.ToString(s_Culture));
        }


        public LiteStringBuilder3 Append(long value)
        {
            bool isNegative = value < 0;
            if (isNegative)
            {
        ...
        private LiteStringBuilder3 Append(ulong value, bool isNegative)
        {
        ...
        public LiteStringBuilder3 Append(double value)
        {
            return Append(value.ToString(s_Culture));
        }
...
#endif
        private LiteStringBuilder3 InternalAppend(float valueF)
        {
            double value = valueF;
        ...
        [ExcludeFromCodeCoverage]
#endif
        private LiteStringBuilder3 InternalAppend(double value)
        {
        ...
        public LiteStringBuilder3 Replace(string oldStr, string newStr)
        {
            if (_bufferPos == 0)
                return this;
        ...
        private void EnsureCapacity(int appendLength)
        {
            ...
            if (pos + appendLength > capacity)
            {
                ...
                int newSize = capacity + appendLength + DefaultCapacity - (capacity - pos);
                char[] newArray = new char[newSize];
                if (pos > 0)
                {
                    Array.Copy(_buffer, 0, newArray, 0, pos);
                }
      
                _buffer = newArray;
                _charsCapacity = newSize;
            }
        }
