...
[assembly: InternalsVisibleTo("LiteStringBuilder10.Tests")]
namespace StringHelper
{
    ...
    ///</summary>
    public class LiteStringBuilder10
    {
...
#pragma warning restore HAA0501 // Explicit new array type allocation
  {
        ...
        /// <summary>
        /// Get a new instance of LiteStringBuilder10
        /// </summary>
        /// <param name="initialCapacity"></param>
        /// <returns></returns>
        public static LiteStringBuilder10 Create(int initialCapacity = DefaultCapacity)
        {
            return new LiteStringBuilder10(initialCapacity);
        }
        ...
        {
            return Equals(obj as LiteStringBuilder10);
        }
        public bool Equals(LiteStringBuilder10 other)
        {
            // Check for null
            if (other is null)
            {
        ...
        public LiteStringBuilder10 Append(params object[] values)
        {
            if (values != null)
            {
        ...
        public LiteStringBuilder10 Append<T>(params T[] values)
        {
        ...
        public LiteStringBuilder10 Append(string value)
        {
            if (value != null)
            {
        ...
        public LiteStringBuilder10 AppendLine()
        {
            return Append(Environment.NewLine);
        }

        ///<summary>Append a string and new line without memory allocation</summary>
        public LiteStringBuilder10 AppendLine(string value)
        {
            Append(value);
            return Append(Environment.NewLine);
        }
        ...
        public LiteStringBuilder10 Append(char value)
        {
        ...
        public LiteStringBuilder10 Append(bool value)
        {
            if (value)
            {
                //true
        ...
        public LiteStringBuilder10 Append(object value)
        {
            if (value is null)
                return this;
        ...
        public LiteStringBuilder10 Append(DateTime value)
        {
        ...
        public LiteStringBuilder10 Append(sbyte value)
        {
            if (value < 0)
            {
        ...
        public LiteStringBuilder10 Append(byte value)
        {
        ...
        public LiteStringBuilder10 Append(uint value)
        {
            return Append((ulong)value, false);
        }

        ///<summary>Append an ulong without memory allocation</summary>
        public LiteStringBuilder10 Append(ulong value)
        {
            return Append(value, false);
        }

        ///<summary>Append an int without memory allocation</summary>
        public LiteStringBuilder10 Append(short value)
        {
        ...
        ///<summary>Append an int without memory allocation</summary>
        public LiteStringBuilder10 Append(int value)
        {
        ...
        public LiteStringBuilder10 Append(float value)
        {
            return Append(value.ToString(s_Culture));
        }

        public LiteStringBuilder10 Append(decimal value)
        {
            return Append(value.ToString(s_Culture));
        }


        public LiteStringBuilder10 Append(long value)
        {
            bool isNegative = value < 0;
            if (isNegative)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private LiteStringBuilder10 Append(ulong value, bool isNegative)
        {
        ...
        public LiteStringBuilder10 Append(double value)
        {
            return Append(value.ToString(s_Culture));
        }
...
#region OLDCODE
...
#endif
        private LiteStringBuilder10 InternalAppend(float valueF)
        {
            double value = valueF;
        ...
        [ExcludeFromCodeCoverage]
#endif
        private LiteStringBuilder10 InternalAppend(double value)
        {
        ...
        public LiteStringBuilder10 Replace(string oldStr, string newStr)
        {
            if (_bufferPos == 0)
                return this;
        ...
        public LiteStringBuilder10 Replace2(string oldStr, string newStr)
        {
            if (_bufferPos == 0)
                return this;
